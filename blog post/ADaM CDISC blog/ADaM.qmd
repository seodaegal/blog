...
ADaM의 첫 번째 데이터 구조는 **ADSL**(Subject-Level Analysis Dataset)이다.
...
#### 3.1. ADAE (Adverse Events Analysis Datset):
...
#### 3.2. ADCM (Concomitant Medications Analysis Datase)
...
<img src="img/tablegenerator.gif" width="662"/>
